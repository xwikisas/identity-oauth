...
import static com.xwiki.identityoauth.internal.IdentityOAuthConstants.IDENTITY_SPACE;

/**
 * Identity OAuth general configuration source. In case no configuration is found on the current wiki, it will use the
...
@Singleton
@Unstable
public class IdentityOAuthGeneralConfigurationSource extends AbstractWikisConfigurationSource
{
    /**
    ...
    private static final LocalDocumentReference CONFIG_CLASS =
        new LocalDocumentReference(IDENTITY_SPACE, "IdentityOAuthGeneralConfigClass");
